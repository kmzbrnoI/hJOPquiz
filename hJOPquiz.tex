...
\section{R – strojvedoucí hJOPdriver}
...
\section{S0 – dispečer minimální}

Úroveň vhodná pro maloše v~kroužku, obsahuje nejnutnější základ pro samostatné
řízení malé stanice v~automatickém režimu bez ručního řízení a editace souprav.
...
\item Vyřešte situaci, kdy vlak rozřízl výhybku a způsobil zkrat.
\end{enumerate}
...
\item Jakými všemi metodami můžete komunikovat s~dispečery sousedních stanic?
...
\subsubsection*{Jízdní cesty}
\begin{enumerate}[leftmargin=*]
\item Jak můžete zrušit jízdní cestu? Popište co nejvíce metod.
...
Opravňuje k~řízení menších stanic, včetně posunů a ručního řízení.

Pro tuto úroveň zaškolení je nutné mít zaškolení na úrovni S0, doporučené je
mít také zaškolení R. Výjimkou je situace, kdy dispečeři používají k~řízení
jízdy jiné prostředky než mobilní aplikaci hJOPdriver.

\subsection{Praktická část}

\subsubsection*{Přihlášení, odhlášení}
\begin{enumerate}[leftmargin=*]
\item Přihlaste se v~režimu čtenáře, demonstrujte přihlášení více panelů.
